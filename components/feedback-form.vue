<template>
	<div class="container-fluid feedback-form">
		<div class="row justify-content-center">
			...
			<div class="col-12 col-md-6 order-1 order-md-2 p-5 d-flex flex-column justify-content-center">
				<form
		...
		handleForm() {
			...
			this.$store
				...
				.then(() => {
					...
					const message = `Новая заявка | Страница - ${form.page} | Имя - ${form.name} | Номер - ${form.phone}`
